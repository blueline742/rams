                ...
                <div className="max-w-xl mx-auto">
                    ...
                    <div className="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-lg">
                        <div className="flex items-start">
                            ...
                            <div className="ml-3">
                                <p className="text-sm text-blue-900 font-semibold">✓ Professional Templates Ready to Customize</p>
                                <p className="text-xs text-blue-800 mt-1">
                                    We've included all common hazards for your trade. Simply review, customize for your specific site conditions, and you're ready to go.
                                </p>
                            </div>
                        </div>
                    </div>
