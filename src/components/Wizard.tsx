                ...
                <div className="max-w-xl mx-auto">
                    ...
                    <div className="mb-6 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg">
                        <div className="flex items-start">
                            ...
                            <div className="ml-3">
                                <p className="text-sm text-amber-800 font-semibold">Important: For Experienced Tradespeople</p>
                                <p className="text-xs text-amber-700 mt-1">
                                    This tool generates professional templates. You must review and adapt this document for your specific site and work conditions. Only competent persons with practical trade experience should complete RAMS documents.
                                </p>
                            </div>
                        </div>
                    </div>
